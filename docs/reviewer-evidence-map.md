...
| Visual assets have explicit page-weight and preload rules. | `docs/asset-performance-policy.md`, `scripts/check-asset-performance-policy.mjs`, `docs/performance-evidence.md` | `npm run audit:asset-policy` verifies image, font, media, and preload guidance before visual additions become performance debt. |
