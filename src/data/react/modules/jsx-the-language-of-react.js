...
export const module2 = {
  ...
  lessons: [
    ...
    },
    {
      ...
      duration: '120 min',
      concepts: [
        'Full CRUD project: Create, Read, Update (toggle complete), Delete tasks. Manages arrays of objects in state.',
        'Form validation: prevent empty submissions. Priority levels (high/medium/low) with color coding.',
        'Filter functionality: show All, Active, or Completed tasks. Task counter shows remaining items.',
        'localStorage persistence: tasks survive page refresh. useEffect syncs state to localStorage on every change.',
      ],
      code: `function TaskManager() {\n    const [tasks, setTasks] = React.useState([]);\n    const [inputValue, setInputValue] = React.useState('');\n    const [filter, setFilter] = React.useState('all');\n    const [priority, setPriority] = React.useState('medium');\n\n    // Save to localStorage on every change\n    React.useEffect(() => {\n        localStorage.setItem('tasks', JSON.stringify(tasks));\n    }, [tasks]);\n\n    function handleAddTask(e) {\n        e.preventDefault();\n        if (!inputValue.trim()) return;\n        setTasks([...tasks, {\n            id: Date.now(),\n            text: inputValue,\n            completed: false,\n            priority\n        }]);\n        setInputValue('');\n    }\n\n    function handleToggle(id) {\n        setTasks(tasks.map(t =>\n            t.id === id ? { ...t, completed: !t.completed } : t\n        ));\n    }\n\n    function handleDelete(id) {\n        setTasks(tasks.filter(t => t.id !== id));\n    }\n}`,
      output: 'A complete task manager with add, complete, delete, filter, priority, and localStorage persistence!',
      tasks: ['Set up state structure for tasks array', 'Build controlled add-task form with validation', 'Display task list with toggle and delete', 'Add priority selector (high/medium/low)', 'Build filter tabs (All/Active/Completed)', 'Add task counter and localStorage'],
      challenge: 'Extend: add edit-in-place for task text, drag-to-reorder, due dates, and categories.',
      devFession: 'I built my first todo app without keys on the list items. When I deleted a task, the wrong one disappeared. Keys are not optional.',
    },
    {
      id: 'r2-7',
      ...
      duration: '20 min',
      concepts: [
        'Module 1 complete! 12 lessons, 2 full projects, 30+ React fundamentals mastered, 25+ components created.',
        'Core skills: React/JSX, components, props, state, events, conditional rendering, lists/keys, controlled forms.',
        'You built: a Weather Dashboard and a Task Manager — real applications with real patterns.',
        'Skill level: Junior React Developer. You can build todo lists, dashboards, form apps, CRUD apps, and component libraries.',
      ],
      code: `// Your Module 1 journey:\n// Lesson 1:  "What is React?" → first component\n// Lesson 5:  "State!" → interactive counter\n// Lesson 10: Weather Dashboard → real app\n// Lesson 11: Task Manager → CRUD mastery\n//\n// Skills unlocked:\n// ✓ JSX syntax\n// ✓ Components & composition\n// ✓ Props (data in)\n// ✓ State (data that changes)\n// ✓ Events (user interaction)\n// ✓ Conditional rendering\n// ✓ Lists & keys\n// ✓ Controlled forms\n// ✓ localStorage\n// ✓ Loading/error states\n//\n// Next: Module 2 — Component Design Patterns`,
      output: 'You can now build real React applications. Module 2 teaches professional patterns used in production.',
      tasks: [],
      challenge: 'Portfolio challenge: polish your Weather Dashboard and Task Manager, add them to your portfolio, and share in #wins.',
      devFession: 'The day I finished my first React module, I rewrote my personal website in React. It took 3 hours and looked the same — but I understood every line. That\'s growth.',
    },
  ],
};
