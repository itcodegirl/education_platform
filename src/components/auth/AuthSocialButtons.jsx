// GitHub + Google sign-in buttons for the auth card. Each click routes
// to the parent's `onSignIn(providerName, signInWithProvider)` handler
// which owns the success/error UI state. Self-contained so the auth
// page no longer carries the SVG markup inline.
  ...
  return (
    <div className="auth-social">
      <button
        ...
        onClick={() => onSignIn('GitHub', signInWithGithub)}
      ...
      <button
        type="button"
        className="auth-social-btn ui-btn ui-btn-secondary"
        onClick={() => onSignIn('Google', signInWithGoogle)}
